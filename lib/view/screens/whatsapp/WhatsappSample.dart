...
import 'package:kelolapps/view/screens/whatsapp/ChatRepo.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

import '../../../utils/fluk/AppTheme.dart';
import 'CustomChatTheme.dart';
...
class _ChatWhatsAppPageState extends State<ChatWhatsAppPage> {
  ...
  initState() {
    ...
    _chatList.add(ChatModel("[Order Otomatis] Pesanan Nomor A30001\n\n"
        "1 Omulette Krispy \n 2 Boba Green Tea varian Besar \n "
        "---------------------- \n"
        "Total Belanja 20000 \n Pembayaran menggunakan OVO", ChatModel.myId,
        DateTime.now().millisecondsSinceEpoch.toString(), "seen"));
    _chatList.add(ChatModel("Selamat Datang di toko maju makmur, baik kak pesanan sudah siap", ChatModel.otherId,
    ...
    return Theme(
      ...
      child: Scaffold(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage(WhatsappRepo.profileAvatar1),
                      fit: BoxFit.fill),
        ...
        body: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(WhatsappRepo.whatsappBackground),
                fit: BoxFit.cover,
              ),
            ),
            child: Container(
